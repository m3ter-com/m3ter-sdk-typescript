...
[![NPM version](<https://img.shields.io/npm/v/m3ter-sdk.svg?label=npm%20(stable)>)](https://npmjs.org/package/m3ter-sdk) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/m3ter-sdk)
...
```sh
npm install git+ssh://git@github.com:stainless-sdks/m3ter-sdk-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npm install m3ter-sdk`
...
1. Via the `M3TER_LOG` environment variable
...
const client = new M3ter({
  logger: logger.child({ name: 'M3ter' }),
...
```ts
import M3ter from 'npm:m3ter-sdk';
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/m3ter-sdk-typescript/issues) with questions, bugs, or suggestions.
