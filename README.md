...
```sh
npm install git+ssh://git@github.com:m3ter-com/m3ter-sdk-typescript.git
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/m3ter-com/m3ter-sdk-typescript/issues) with questions, bugs, or suggestions.
